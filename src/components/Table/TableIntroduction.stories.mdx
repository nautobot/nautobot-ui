...
There are two approaches to building tables with `nautobot-ui`:
  ...
  1. [**With helpers (Table Renderer)**](/story/table--table-renderer), using
  `TableRenderer` component and `useTableRenderer` hook.
  ...
  2. [**From scratch (Basic)**](/story/table--basic), using basic components as
  building blocks.
